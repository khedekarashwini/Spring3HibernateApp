...
public class EmployeeController {
	...
	public ModelAndView LoginEmployee1(@ModelAttribute("command") LoginBean loginBean,
			BindingResult result) {
	...
	public ModelAndView saveEmployee(@ModelAttribute("command") LoginBean loginBean, 
			BindingResult result) {
		if(loginBean.getId().equals(123)&&loginBean.getPassword().equals("ashu"))
		{
